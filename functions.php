...
function BlackCooler_scripts() {
	...
	wp_enqueue_script( 'font-awesome-script', get_template_directory_uri() . '/js/all.min.js', array('jquery-script'), '5.15.4', false );
	...
	wp_enqueue_script( 'control-script', get_template_directory_uri() . '/js/control.js', array('jquery-script'), '1.0.0', false );
